...
Choices.prototype.search = function(str) {
  this.choices = this.initChoices.filter(function(choice){
    return choice instanceof Separator || choice.value.toLowerCase().indexOf(str) >= 0;
  });
  this.realChoices = this.choices.filter(Separator.exclude);
  return this;
}
Choices.prototype.restablish = function() {
